  ...
  return (
    <TouchableOpacity
      style={[
        styles.container,
        {
          backgroundColor: nearLimit ? 'rgba(201,168,76,0.07)' : colors.bgSection,
          borderColor: nearLimit ? 'rgba(201,168,76,0.35)' : colors.border,
        },
      ]}
      onPress={onPress}
      activeOpacity={0.82}
    >
      <Animated.View
        style={[
          styles.dot,
          { opacity: glow, backgroundColor: nearLimit ? '#C9A84C' : colors.textMuted },
        ]}
      />
      ...
      <View style={styles.textBlock}>
        {nearLimit ? (
          ...
          <Text style={[styles.label, { color: colors.textMuted }]}>
            Sagesse {currentIndex + 1} sur {FREE_CARD_LIMIT} · Emunah Premium
          </Text>
        )}
      </View>
      ...
      <View
        style={[
          styles.pill,
          { backgroundColor: 'rgba(201,168,76,0.12)', borderColor: 'rgba(201,168,76,0.3)' },
        ]}
      >
