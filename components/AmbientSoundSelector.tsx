        ...
        {AMBIENT_TRACKS.map((track) => {
          ...
          return (
            ...
            >
              ...
              <Text
                style={[styles.trackLabel, { color: isActive ? accent : colors.textMuted }]}
                numberOfLines={2}
              >
                {track.label}
              </Text>
        ...
        <View style={styles.volumeRow}>
          ...
          >
            <View
              style={[
                styles.sliderFill,
                { width: `${prefs.volume * 100}%` as any, backgroundColor: accent },
              ]}
            />
            <View
              style={[
                styles.sliderThumb,
                { backgroundColor: accent, left: `${prefs.volume * 100}%` as any },
              ]}
            />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => handleVolume(Math.min(1, prefs.volume + 0.1))}
            style={styles.volBtn}
          >
            <Text style={[styles.volLabel, { color: colors.textMuted }]}>🔊</Text>
          </TouchableOpacity>
