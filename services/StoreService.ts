...
const RC_KEY_IOS     = process.env.EXPO_PUBLIC_RC_KEY_IOS_EMUNAH     ?? '';
const RC_KEY_ANDROID = process.env.EXPO_PUBLIC_RC_KEY_ANDROID_EMUNAH ?? '';
const PREMIUM_ENTITLEMENT = 'premium';
const CACHE_KEY = 'emunah_rc_premium_v1';
...
const MockStore = {
  async purchase(_productId: ProductId): Promise<PurchaseResult> {
    ...
    if (_productId.startsWith('emunah_premium')) {
